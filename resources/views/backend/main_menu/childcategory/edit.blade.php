                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                                    ...
                                                    <select class="form-control select2bs4" style="width: 100%;"
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                @if ($category->id === $childcategory->subcategory->category_id) {{ 'selected' }} @endif>
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">__Childcategory Name</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $childcategory->bn_name }}"
                                                name="bn_name">
                                        </div>
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                $('select[name="subcategory_id"]').append(
                                    '<option>==Select==</option><option value="' +
                                    value.id + '">' + value
                                    .name + '</option>');
                            });
                        },
