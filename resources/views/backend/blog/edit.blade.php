                        ...
                        <form action="{{ route('admin.blogs.update', $blog) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        placeholder="Enter blog name" name="author" value="{{ $blog->author }}">
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                                    ...
                                                    @foreach ($blog_categories as $category)
                                                        <div class="icheck-danger">
                                                            <input type="checkbox" value="{{ $category->id }}"
                                                                id="{{ $category->name }}" {{ in_array($category->id, old('categories', $blog->blogCategories->pluck('id')->toArray())) ? 'checked' : '' }} name="categories[]">
                                                    ...
                                                    @foreach ($blog_tags as $tag)
                                                        <div class="icheck-danger">
                                                            <input type="checkbox" value="{{ $tag->id }}"
                                                                id="{{ $tag->name }}" {{ in_array($tag->id, old('tags', $blog->blogTags->pluck('id')->toArray())) ? 'checked' : '' }} name="tags[]">
                                                            <label for="{{ $tag->name }}">
                                                                {{ $tag->name }}
                                                            </label>
                                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    placeholder="Enter blog name" name="bn_name" value="{{ $blog->bn_name }}">
                                            </div>
            
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">__Author Name</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    placeholder="Enter blog name" name="bn_author" value="{{ $blog->bn_author }}">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card card-outline card-info">
                                                        ...
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                                            <textarea id="summernote1" name="bn_details">{!! $blog->bn_details !!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.col-->
