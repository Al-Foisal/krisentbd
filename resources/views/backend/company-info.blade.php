                        ...
                        <form action="{{ route('admin.storeCompanyInfo') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Phone Three(Customer care)</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if (!empty($info->favicon))
                                                <img src="{{ asset($info->favicon) }}" height="50" width="50" alt="">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">__About (in a nutshell)</label>
                                        <textarea name="bn_about" class="form-control" rows="2"
                                            placeholder="Enter about">{{ $info->bn_about ?? '' }}</textarea>
                                    </div>
    
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">__Address</label>
                                        <textarea name="bn_address" class="form-control" rows="2"
                                            placeholder="Enter address">{{ $info->bn_address ?? '' }}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
    
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">__Phone One</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    placeholder="Enter phone one" name="bn_phone_one"
                                                    value="{{ $info->bn_phone_one ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">__Phone Two</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    placeholder="Enter phone two" name="bn_phone_two"
                                                    value="{{ $info->bn_phone_two ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">__Phone Three(Customer care)</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    placeholder="Enter phone three" name="bn_phone_three"
                                                    value="{{ $info->bn_phone_three ?? '' }}">
                                            </div>
                                        </div>
