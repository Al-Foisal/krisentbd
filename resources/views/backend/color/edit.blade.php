...
@section('title', 'Product Color Update')
@section('cssLink')
@endsection
@section('cssStyle')
@endsection
                        ...
                        <form action="{{ route('admin.colors.update', $color) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="color" class="form-control" id="exampleInputEmail1"
                                                value="{{ $color->color_code }}" name="color_code">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">__Color name</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                            value="{{ $color->bn_color }}" name="bn_color">
                                        </div>
                                    </div>
                                </div>
                            </div>
