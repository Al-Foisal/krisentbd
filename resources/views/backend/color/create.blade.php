                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div
                                                ...
                                                <input type="text" name="bn_color[]" placeholder="Enter color name bangla"
                                                    class="myfrm form-control">
                                            ...
                                            <div class="clone hide">
                                                <div class="hdtuto control-group lst input-group" style="margin-top:10px">
                                                    ...
                                                    <input type="text" name="color[]" placeholder="Enter color name"
                                                        class="myfrm form-control">
                                                    <input type="text" name="bn_color[]"
                                                        placeholder="Enter color name bangla" class="myfrm form-control">
                                                    <div class="input-group-btn">
