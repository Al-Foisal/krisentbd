                            ...
                            <div class="card-body">
                                ...
                                <div class="cart-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            value="{{ $testimonial->bn_name }}" name="bn_name">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputEmail1">__Designation</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            value="{{ $testimonial->bn_designation }}" name="bn_designation">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-outline card-info">
                                                ...
                                                <!-- /.card-header -->
                                                <div class="card-body">
                                                    <textarea class="form-control" name="bn_details">{{ $testimonial->bn_details }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.col-->
