...
@section('backend')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Client Logo</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Create Client Logo</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="bg-primary">All image will 200x50</div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="col-lg-12">
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title">Images:<span class="text-danger">*</span>
                                        </h3>
                                    </div>
                                    <div class="card-body">
